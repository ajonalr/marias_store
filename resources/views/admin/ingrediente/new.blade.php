      ...
      <div class="card p-4 mb-5">
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <form action="{{route('ingrediente.store_ingredienteMenu')}}" method="post">
              @csrf
              <!-- articulos -->
              <div class="form-group row">
                ...
                <div class="form-group col-md-2">
                  <p>Ingrediente</p>
                  <select class="form-control" name="ing" id="ingrediente" autofocus>
                    <option value="">Seleccione Ingrediente</option>
                    @foreach($ingre as $art)
                    <option value="{{$art->id}}">{{$art->nombre}} <?php echo $art->descripcion; ?> </option>
                    @endforeach
                  </select>
  ...
  function agregar_bolsa() {
    ...
    if (bolsa_id_table != "" && bolsa_pventa_table != "" && cantidad_bolsa != "") {
      ...
      var fila = '<tr class="selected" id="fila' + tcontador_bolsa + '">' +
        ...
        '<td ><input type="hidden" class="form-control invisible"  name="ingrediente_v[]" value="' + ing.val() + '" readonly> ' + 'Codigo de Ingrediente: ' + ing.val() + ' </td> ' +
